...
void main() {
  ...
  print('Welcome to Tic-Tac-Toe A platform where geniuses are made!\n');  // Print a welcome message
  printBoard(board);  // Call a function to print the current state of the board

  while (true) {
    print('\n${isPlayer1Turn ? "Player Genius" : "Player Amateur"}, enter your move (1-9): ');  // Prompt the current player to enter their move
    ...
    try {
      ...
      if (checkWin(board)) {  // Check if there is a winner
        print('${isPlayer1Turn ? "Player Genius" : "Player Amateur1"} wins!');
        break;
